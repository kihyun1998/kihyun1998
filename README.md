...
&nbsp;&nbsp;
<img src="https://github-readme-stats-delta-five-gb9gi19o85.vercel.app/api/top-langs/?username=kihyun1998&layout=compact&exclude_repo=TIL,kihyun1998.github.io&hide=Jupyter%20Notebook&bg_color=0a0a0a&title_color=fafafa&text_color=a3a3a3&border_color=262626" height="180"/>
...
|:-------:|:-------:|:------------|
| [**flutter_bin**](https://pub.dev/packages/flutter_bin) | [![Pub Version](https://img.shields.io/pub/v/flutter_bin?color=blue)](https://pub.dev/packages/flutter_bin) | Extract metadata (version, product name, etc.) from desktop binaries |
| [**x509_cert_store**](https://pub.dev/packages/x509_cert_store) | [![Pub Version](https://img.shields.io/pub/v/x509_cert_store?color=blue)](https://pub.dev/packages/x509_cert_store) | X.509 certificate store with macOS/Windows Keychain integration |
| [**flutter_alone**](https://pub.dev/packages/flutter_alone) | [![Pub Version](https://img.shields.io/pub/v/flutter_alone?color=blue)](https://pub.dev/packages/flutter_alone) | Single instance enforcement and user detection utility |
| [**flutter_inactive_timer**](https://pub.dev/packages/flutter_inactive_timer) | [![Pub Version](https://img.shields.io/pub/v/flutter_inactive_timer?color=blue)](https://pub.dev/packages/flutter_inactive_timer) | Desktop timer utility for detecting user inactivity |
| [**flutter_ime**](https://pub.dev/packages/flutter_ime) | [![Pub Version](https://img.shields.io/pub/v/flutter_ime?color=blue)](https://pub.dev/packages/flutter_ime) | IME control plugin (English switch, input source detection, Caps Lock state) |
| [**flutter_password_input**](https://pub.dev/packages/flutter_password_input) | [![Pub Version](https://img.shields.io/pub/v/flutter_password_input?color=blue)](https://pub.dev/packages/flutter_password_input) | Password field with Caps Lock detection, visibility toggle, and theming |
